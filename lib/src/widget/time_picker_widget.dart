...
class _TimePickerWidgetState extends State<TimePickerWidget> {
  ...
  _TimePickerWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime,
      int? minuteDivider) {
    this._minTime = minTime ?? DateTime.parse(DATE_PICKER_MIN_DATETIME);
    this._maxTime = maxTime ?? DateTime.parse(DATE_PICKER_MAX_DATETIME);
    this._currHour = (initTime ?? DateTime.now()).hour;
    this._currMinute = (initTime ?? DateTime.now()).minute;
    this._currSecond = (initTime ?? DateTime.now()).second;
